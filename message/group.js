...
if(type1){
WelcomeType1(from, intro, fake, ppUser, ppGc, butIn,{ "mentionedJid": [mem]})
} else if(type2){
WelcomeType2(from, intro, fake, ppUser, ppGc, butIn,{ "mentionedJid": [mem]})
} else if(type3){
WelcomeType3(from, intro, fake, ppUser, ppGc, butIn,{ "mentionedJid": [mem]})
}
} else if(Remove && NotMe){      
let ppUser = await getBuffer(pp_user)
let ppGc = await getBuffer(pp_grup)
if(type1){
WelcomeType1(from, outro, fake, ppUser, ppGc, butOut,{ "mentionedJid": [mem]})
} else if(type2){
WelcomeType2(from, outro, fake, ppUser, ppGc, butOut,{ "mentionedJid": [mem]})
} else if(type3){
WelcomeType3(from, outro, fake, ppUser, ppGc, butOut,{ "mentionedJid": [mem]})
}
